...
function FeatureCard({ title, subtitle, imageUrl }: { title: string; subtitle: string; imageUrl: string }) {
  return (
...
export default function FeatureCarousel({ carouselRef }: { carouselRef: React.RefObject<HTMLDivElement> }) {
