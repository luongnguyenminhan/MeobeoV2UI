...
const FooterSection = ({ id }: { id: string }) => {
  ...
  return (
    <footer
      ref={footerRef}
      id={id}
      className="relative w-full left-1/2 right-1/2 -mx-[50vw] h-auto py-8 lg:py-16 bg-gradient-to-r from-[var(--primary-color)] to-[var(--secondary-color)] px-4 sm:px-6 lg:px-8"
